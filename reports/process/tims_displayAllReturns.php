...
$sql_select = "SELECT b.return_log_id, b.return_log_date_created, i.item_name, CONCAT(u.user_last_name, ', ', u.user_first_name) AS \"item_returner\", b.return_log_item_returner_external
FROM return_log b
